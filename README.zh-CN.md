...
> 原始实验报告、论文生成工作区、一次性恢复脚本和私有任务证据保存在源码分发之外；少量经过明确
> 说明和脱敏的论文可以作为工作流产物发布在 `docs/case-studies/` 下。Demo 或模拟测试通过，并不
> 构成一次新的真实服务商或密封测试研究运行。
...
<div align="center">
  <img src="docs/assets/pathology-ai-workflow-zh-CN.png" width="760" alt="病理 AI 科研工作流" />
</div>
